...
class crudSignUp extends StatefulWidget {
  const crudSignUp({super.key});

  @override
  State<crudSignUp> createState() => _crudSignUpState();
}

class _crudSignUpState extends State<crudSignUp> {
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(onPressed: ()async {
                ...
                if(msg == "Account created successfully!"){addData();
                  //addData();


                  Navigator.of(context).push(MaterialPageRoute(builder: (context)=>crudSignIn()));
                }
